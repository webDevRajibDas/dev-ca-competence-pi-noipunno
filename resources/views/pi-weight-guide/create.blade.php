...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <h2 class="p-2">Competence</h2>
            <div class="shadow-sm p-2 rounded my-2 custom-card">
                <div class="">

                    <form method="POST" action="{{ route("pi-weight.store") }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="mb-3 input-container">
                                    ...
                                    <select class="form-select custom-input-form" aria-label="Default select example" name="pi_uid" id="pi_uid">
                                        ...
                                        @foreach($pis as $pi)
                                        <option class="pi-option competence-{{$pi->competence_uid}}" value="{{$pi->uid}}">{{ $pi->name_bn ?? $pi->name_en }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row guide" id="guide">
                                <div class="col-md-6">
                                    <div class="mb-3 input-container">
                                        ...
                                        <textarea class="custom-input-form" id="guide_en" aria-describedby="guide_en" name="guide_en"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 input-container">
                                        ...
                                        <textarea class="custom-input-form" id="guide_bn" aria-describedby="guide_bn" name="guide_bn"></textarea>
                                    </div>
                                </div>

...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <h2 class="p-2 custom-class-title">PI to PI সমতা</h2>
            <div class="shadow-sm p-2 rounded my-2 custom-card">
                <div class="">

                    <form method="POST" action="{{ route("pi-similarity.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div>
                            <hr><h1 class="d-flex justify-content-center mb-3 custom-class-title">Is Similar To Pi</h1>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3 input-container">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3 input-container">
                                    ...
                                    <select class="form-select custom-input-form" aria-label="Default select example" name="similar_pi_id" id="spi_uid">
                                        <option value="">PI নির্বাচন করুন</option>
                                        @foreach($pis as $pi)
                                        <option class="spi-option competence-{{$pi->competence_uid}}" value="{{$pi->uid}}">{{ $pi->name_bn ?? $pi->name_en }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>

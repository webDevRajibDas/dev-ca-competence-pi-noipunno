        ...
        <div class="col-md-12">
            ...
            <div class="shadow-sm p-2 rounded my-2 custom-card">
                <div class="">
                    ...
                    <form method="POST" action="{{ route("bi.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3 input-container">
                                    ...
                                    <input type="number" class="custom-input-form" aria-describedby="bi_id"
                                        name="bi_id">
                                </div>
                            </div>
                            ...
                            <div>
                                <hr><h1 class="d-flex justify-content-center mb-3 custom-class-title">Bi মাত্রা</h1>
                            </div>

                            @foreach($weights as $weight)
                            <div id="additional-rows">
                                <div>
                                    <hr><h1 class="d-flex justify-content-center mb-3 custom-class-title">{{$weight->name}}</h1>
                                </div>
                                <div class="row guide" id="guide">
                                    <input type="hidden" value="{{@$weight->uid}}" class="form-control" aria-describedby="weight_uid" name="weight_uid[]">
                                    <div class="col-md-6">
                                        <div class="mb-3 input-container">
                                            <label for="title_en" class="form-label">টাইটেল (EN)</label>
                                            <textarea class="custom-input-form" id="title_en" aria-describedby="title_en" name="title_en[]"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3 input-container">
                                            ...
                                            <textarea class="custom-input-form" id="title_bn" aria-describedby="title_bn" name="title_bn[]"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3 input-container">
                                            ...
                                            <textarea class="custom-input-form" id="description" aria-describedby="description" name="details[]"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>

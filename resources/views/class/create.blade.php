...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <h2 class="p-2 custom-class-title">শ্রেণী</h2>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="mb-3 input-container">
                                    ...
                                    <input type="number" class="custom-input-form" aria-describedby="class_id" name="class_id" required>
                                </div>
                                <div class="mb-3 input-container">
                                    <label for="name_bn" class="custom-label">শ্রেণীর নাম (BN)</label>
                                    <input type="text" class="custom-input-form" aria-describedby="name_bn" name="name_bn">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3 input-container">
                                    <label for="name_en" class="custom-label">শ্রেণীর নাম (EN)</label>
                                    <input type="text" class="custom-input-form" aria-describedby="name_en" name="name_en">
                                </div>
                                <div class="mb-3 input-container">
                                    <label for="class_code" class="custom-label">শ্রেণী কোড</label>
                                    <input type="text" class="custom-input-form" aria-describedby="class_code" name="class_code">
                                </div>
                            </div>

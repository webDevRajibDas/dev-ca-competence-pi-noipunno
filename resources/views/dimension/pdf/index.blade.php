    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h2 class="my-3 custom-class-title">অভিজ্ঞতা অনুযায়ী ডাইমেনশন সমূহ ডাউনলোড করুন</h2>
                        <form method="GET" action="{{ route('dimension-pdf-download') }}" enctype="multipart/form-data">
                            @csrf

                                ...
                                <div class="mb-3 input-container">
                                    ...
                                    <div class="form-group form-check">
                                        <div id="pi_div">
                                            @foreach ($bis as $bi) 
                                                @php
                                                    $pis = \App\Models\BiDimensionToBi::where('bi_uid', $bi->uid)->where('bi_dimension_uid', $dimension->uid)->count();
                                                // echo $pis->uid;
                                                @endphp
                                                <div class="form-group form-check">
                                                    <input type="checkbox" class="form-check-input" id="bi_uid[{{ $bi->uid }}]" name="bi_uid[{{ $bi->uid }}]" @if($pis >= 1) checked @endif>

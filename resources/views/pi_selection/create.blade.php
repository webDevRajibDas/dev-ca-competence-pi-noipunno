                            ...
                            <div class="col-md-4">
                                <div class="mb-3 input-container">
                                    ...
                                    {{-- <input type="text" class="form-control" aria-describedby="session" value="{{ @$editData->session }}"
                                        name="session" placeholder="Example: 2023"> --}}
                ...
                if (response) {
                    $.each(response.pis, function(index, category) {
                        html += `
                            ...
                            <label class="form-check-label" for="pi_uid[${category.uid}]">${category.competence.class_uid}.${category.competence.competence_id}.${category.pi_id} - ${category.name_bn ?? category.name_en}</label>
                            </div>
                        `;
                    });
                }
